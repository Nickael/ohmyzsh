...
# or wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/nickael/ohmyzsh/master/tools/install.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/nickael/ohmyzsh/master/tools/install.sh
#   sh install.sh
#
